    ...
    return __generator(this, function (_a) {
        switch (_a.label) {
            ...
            case 2:
                // Clear existing data
                _a.sent();
                return [4 /*yield*/, book_model_1.Book.deleteMany({})];
            case 3:
                _a.sent();
                // Insert new data
                return [4 /*yield*/, user_model_1.User.insertMany(data_1.users)];
            case 4:
                // Insert new data
                _a.sent();
                return [4 /*yield*/, book_model_1.Book.insertMany(data_1.books)];
            case 5:
                _a.sent();
                return [3 /*break*/, 8];
            case 6:
